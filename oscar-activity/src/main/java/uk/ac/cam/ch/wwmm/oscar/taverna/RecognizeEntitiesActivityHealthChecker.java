 ...
 * 
 */
public class RecognizeEntitiesActivityHealthChecker implements
		HealthChecker<RecognizeEntitiesActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof RecognizeEntitiesActivity;
	}
	...
	public VisitReport visit(RecognizeEntitiesActivity activity, List<Object> ancestry) {
		RecognizeEntitiesActivityConfigurationBean config = activity.getConfiguration();
		...
		return new VisitReport(HealthCheck.getInstance(), activity,
				"Oscar4 service OK", HealthCheck.NO_PROBLEM, subReports);
	}
